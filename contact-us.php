...
$sql1="INSERT INTO tanya (nama,email,telp,pesan) VALUES('$name','$email','$telp','$message')";
  ...
  <div class="container">
    <div  class="row">
      <div class="col-md-5">
        ...
        <h6>Silahkan Isi Form Berikut:</h6>
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" name="telp" class="form-control white_bg" id="phonenumber" required>
            </div>
            <div class="form-group">
...
?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href=""><?php   echo htmlentities($result['telp']); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href=""><?php   echo htmlentities($result['email']); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
